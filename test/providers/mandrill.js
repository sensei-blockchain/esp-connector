...
describe("Mandrill", function() {
  ...
  describe("_prepareToField()", function() {
    it("should return formatted `to` field(for type=to) as required by mandrill", function(done) {
      var to = provider._prepareToField(["blockchainj7458@gmail.com", "blockchainj7458+1@gmail.com"], "to");
  ...
  describe("_prepareFormData()", function() {
    ...
    it("should return form data in JS object", function(done) {
      ...
      chai.expect(formdata.message.from_email).to.equal("blockchainj7458@gmail.com");
      ...
      chai.expect(formdata.message.to[0].email).to.equal("blockchainj7458@gmail.com");
      ...
      chai.expect(formdata.message.to[1].email).to.equal("blockchainj7458+1@gmail.com");
      ...
      chai.expect(formdata.message.to[2].email).to.equal("blockchainj7458+2@gmail.com");
      chai.expect(formdata.message.to[2].type).to.equal("cc");
      chai.expect(formdata.message.subject).to.equal("Hello Sensei Blocchain");
      chai.expect(formdata.message.text).to.equal("Congratulations Sensei Blocchain, you just sent an email!");
      done();
    });
  });
  ...
  describe("_prepareRequest()", function() {
    it("should return options JS object for request.js", function(done) {
      ...
      chai.expect(request.form.message.from_email).to.equal("blockchainj7458@gmail.com");
      ...
      chai.expect(request.form.message.to[0].email).to.equal("blockchainj7458@gmail.com");
      ...
      chai.expect(request.form.message.to[1].email).to.equal("blockchainj7458+1@gmail.com");
      ...
      chai.expect(request.form.message.to[2].email).to.equal("blockchainj7458+2@gmail.com");
      chai.expect(request.form.message.to[2].type).to.equal("cc");
      chai.expect(request.form.message.subject).to.equal("Hello Sensei Blocchain");
      chai.expect(request.form.message.text).to.equal("Congratulations Sensei Blocchain, you just sent an email!");
      done();
    });
  });
