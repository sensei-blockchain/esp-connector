...
describe("Sendgrid", function() {
  ...
  describe("_prepareFormData()", function() {
    ...
    it("should return form data in JS object", function(done) {
      ...
      chai.expect(formdata["to[]"][0]).to.be.equal("blockchainj7458@gmail.com");
      chai.expect(formdata["to[]"][1]).to.be.equal("blockchainj7458+1@gmail.com");
      chai.expect(formdata["cc[]"]).to.be.a("Array");
      chai.expect(formdata["cc[]"]).to.have.length(1);
      chai.expect(formdata["cc[]"][0]).to.be.equal("blockchainj7458+2@gmail.com");
  ...
  describe("_prepareRequest()", function() {
    it("should return options JS object for request.js", function(done) {
      ...
      chai.expect(request.form["to[]"][0]).to.be.equal("blockchainj7458@gmail.com");
      chai.expect(request.form["to[]"][1]).to.be.equal("blockchainj7458+1@gmail.com");
      chai.expect(request.form["cc[]"]).to.be.a("Array");
      chai.expect(request.form["cc[]"]).to.have.length(1);
      chai.expect(request.form["cc[]"][0]).to.be.equal("blockchainj7458+2@gmail.com");
